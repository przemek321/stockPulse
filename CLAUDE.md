...
42 tickery aktywne (28 healthcare + 14 semi observation) + 9 soft-deleted, 33 REST endpoints (po Tier 1), 14 TypeORM entities, 8 BullMQ queues, 8 active alert rules (w tym Form 4 Insider BUY z Director ×1.15 boost post-Sprint 17 P1), 12 disabled rules, 22 @Logged methods w ~12 services. C-suite + Director SELL w observation mode (V4+V5 backed). Backtest V5 (f69cfa8): 128 testów (threshold p<0.000391), 19 Bonferroni ✓, healthcare SELL zero edge, control SELL d=+0.10 30d ✓✓✓, cluster vs solo BUY p>0.37.
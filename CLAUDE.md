...
2. **Warstwa AI** — 2-etapowy pipeline z tier-based eskalacją:
   ...
   - **Price Outcome Tracker** (`src/price-outcome/`): zapis ceny w momencie alertu (Finnhub /quote), CRON co 1h uzupełnia price1h/4h/1d/3d, max 30 zapytań/cykl
